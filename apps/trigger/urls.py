...
urlpatterns = [
    ...
    path('system/resource/<str:source_type>/<str:source_id>/trigger/<str:trigger_id>', views.SystemResourceTriggerView.Operate.as_view(), name='system task source trigger operate'),
    path('system/resource/<str:source_type>/<str:source_id>/trigger', views.SystemResourceTriggerView.as_view(), name='system task source trigger'),
