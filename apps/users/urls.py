...
urlpatterns = [
    ...
    path(
        "workspace/<str:workspace_id>/user_member",
        views.WorkspaceUserMemberView.as_view(),
        name="test_workspace_id_permission",
    ),
    path(
        "workspace/<str:workspace_id>/user/profile",
        views.TestWorkspacePermissionUserView.as_view(),
        name="test_workspace_id_permission",
    ),
