...
from common.result import ResultSerializer, DefaultResultSerializer, ResultPageSerializer
from models_provider.serializers.model_serializer import (
    ModelModelSerializer,
    ModelCreateRequest,
    SystemResourceModelItemSerializer,
    SystemResourceModelQuerySerializer,
)
...
class SystemResourceModelPageResult(ResultPageSerializer):
    def get_data(self):
        return SystemResourceModelItemSerializer(many=True)


class SystemResourceModelQueryAPI(APIMixin):
    @staticmethod
    def get_parameters():
        return [
            OpenApiParameter(
    ...
    @staticmethod
    def get_request():
        return SystemResourceModelQuerySerializer

    @staticmethod
    def get_response():
        return SystemResourceModelPageResult
