...
from models_provider.shared.capabilities import DownloadableEmbeddingModel
...
class XinferenceEmbeddingModelCredential(BaseForm, BaseModelCredential):
    def is_valid(self, model_type: str, model_name, model_credential: Dict[str, object], model_params, provider,
        ...
        model: DownloadableEmbeddingModel = provider.get_model(model_type, model_name, model_credential)
        if len(exist) == 0:
